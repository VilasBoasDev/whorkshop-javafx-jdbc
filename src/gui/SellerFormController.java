...
public class SellerFormController implements Initializable {
	...
	// ← ÚNICA MUDANÇA: "departmentservice" → "departmentService"
	...
	public void loadAssociatedObjects() {
	    ...
	    obsList = javafx.collections.FXCollections.observableArrayList(list);  // ← inicializa obsList
	    comboBoxDepartment.setItems(obsList);  // ← agora funciona!
	}
